...
import com.example.punayog.databinding.ActivityOtpVerifyBinding;
...
public class OtpVerifyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.tvMobile.setText(String.format(
                "+977-%s", getIntent().getStringExtra("phone")
        ));
    ...
    private void autoOtpReceiver() {
        ...
        otp_receiver.intiListener(new OTP_Receiver.OtpReceiverListener() {
            @Override
    ...
    private void againOtpSend() {
        ...
        PhoneAuthOptions options =
                PhoneAuthOptions.newBuilder(mAuth)
                        .setPhoneNumber("+977" + getIntent().getStringExtra("phone").trim())
